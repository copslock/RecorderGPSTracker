...
static void auto_test_recoder_create(void);
static void auto_test_recoder_destroy(void);
...
static void struct_to_jsonstr(const AutoTestResult result,char* json_str)
{
	...
	json_add_int(p_result_root, "recoder_file_counts", result.recoder_file_counts);
...
void auto_test_recoder_file_count(void)
{
	s_auto_test.test_result.recoder_file_counts++;
}
