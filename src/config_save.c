...
static void config_service_set_factory_deault(void)
{
	...
	value_u8 = GPS_NMEA_OUTPUT_INTERVAL;
    config_service_set(CFG_NMEATIME, TYPE_BYTE, &value_u8, sizeof(value_u8));
...
static void config_service_set_deault(void)
{
    ...
    config_service_set(CFG_SERVERADDR, TYPE_STRING, CONFIG_LITE_SERVER_ADDERSS, GM_strlen(CONFIG_LITE_SERVER_ADDERSS));
...
static void convert_cfg_to_para(GprsParaFileType *para)
{
	...
	config_service_get(CFG_NMEATIME, TYPE_BYTE, &value_u8, sizeof(value_u8));
    para->nmea_output_interval = value_u8;
}
...
static void convert_para_to_cfg(const GprsParaFileType *para)
{
	...
	value_u8 = para->nmea_output_interval;
	config_service_set(CFG_NMEATIME, TYPE_BYTE, &value_u8, sizeof(value_u8));
