...
GM_ERRCODE system_state_set_recoder(bool state)
{
	if (state == system_state_get_recoder())
	{
		return GM_SUCCESS;
	}
	...
	LOG(INFO,"system_state_set_recoder");
	//频繁变化，不保存到文件
	return save_state_to_file();
}


bool system_state_get_recoder(void)
{
